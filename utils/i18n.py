...
LANG: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "role_regional_officer":                "Regional Officer",
        "role_privacy_steward":                 "Privacy Steward",
        "role_privacy_operations":              "Privacy Operations",
        ...
        # ── Rights portal — missing keys (rights_portal.py) ──────────────────
        "assigned_on_submit":                   "assigned on submit",
        "closed_on_time":                       "Closed On Time",
        "closed_resolved_within_window":        "Closed — resolved within SLA window",
        "closure_blocked":                      "Closure Blocked",
        "days_remaining_until":                 "days remaining until",
        "enter_above":                          "enter above",
        "escalated_priority_attention":         "Escalated — priority attention required.",
        "identity_verification_failed":         "Identity Verification Failed",
        "identity_verification_required":       "Identity Verification Required",
        "identity_verification_warning":        "This request type requires identity verification before submission.",
        "identity_verified_at":                 "Identity Verified At",
        "identity_verified_by":                 "Identity Verified By",
        "left":                                 "left",
        "must_confirm_id_verification_before":  "You must confirm identity verification before submitting a",
        "of":                                   "of",
        "on_date":                              "on",
        "policy_violation":                     "Policy violation",
        "request_blocked":                      "Request Blocked",
        "request_blocked_consent_gate":         "Request Blocked — Consent Gate",
        "request_overdue_by":                   "Request overdue by",
        "request_submitted_success":            "Request submitted successfully. ID:",
        "requests":                             "Requests",
        "requests_escalated_at":                "request(s) escalated at",
        "requests_require_dpo_attention":       "request(s) require DPO attention.",
        "requires_dpo_attention":               "Requires DPO attention.",
    ...
    "ml": {
        ...
        "role_regional_officer":                "റീജിയണൽ ഓഫീസർ",
        "role_privacy_steward":                 "സ്വകാര്യത സ്റ്റുവാർഡ്",
        "role_privacy_operations":              "സ്വകാര്യത പ്രവർത്തന സംഘം",
        "role_soc_analyst":                     "സോക് അനലിസ്റ്റ്",
        "role_dpo":                             "ഡിപിഒ",
        ...
        "weighted_score_label":         "ഭാരിത സ്കോർ",
        "ledger_root_hash":             "ലെഡ്ജർ റൂട്ട് ഹാഷ്",
        "root_hash_caption":            "മുഴുവൻ ലെഡ്ജറിന്റെ SHA-256 ഹാഷ്.",
        "root_hash_note":               "ഈ ഹാഷ് ഓഡിറ്റ് ലെഡ്ജറിന്റെ നിലവിലെ അവസ്ഥ തിരിച്ചറിയുന്നു.",
        "root_hash_more_info":          "ബാഹ്യ കൃത്രിമ കണ്ടെത്തലിന് റൂട്ട് ഹാഷ് ഉപയോഗിക്കാം.",
        "root_hash_unavailable":        "റൂട്ട് ഹാഷ് ഇതുവരെ സൃഷ്ടിച്ചിട്ടില്ല.",
        "ledger_integrity_metadata":    "ലെഡ്ജർ സമഗ്രതാ മെറ്റാഡാറ്റ",
        "integrity_metadata_note":      "ഈ മെറ്റാഡാറ്റ ലൈവ് ലെഡ്ജറിൽ നിന്ന് ക്രിപ്‌റ്റോഗ്രാഫിക്കലി ഉത്ഭവിച്ചതാണ്.",
        "total_entries":                "ആകെ എൻട്രികൾ",
        "root_hash":                    "റൂട്ട് ഹാഷ്",
        "dpia_caption":                 "ഡിപിഡിപി നിയമം 2023 സെക്ഷൻ 10 — സ്വകാര്യതാ ആഘാത വിലയിരുത്തലുകൾ.",
        "dpia_more_info":               "ഉയർന്ന അപകടസാധ്യതയുള്ള ഡാറ്റ പ്രോസസ്സിംഗ് പ്രവർത്തനങ്ങൾക്ക് ഡിപിഐഎ ആവശ്യമാണ്.",
        "dpo_console_more_info":        "ഡിപിഒ കൺസോൾ എല്ലാ അവകാശ അഭ്യർത്ഥനകളും അവലോകനം ചെയ്യാനും തീരുമാനിക്കാനും അനുവദിക്കുന്നു.",
        "dpo_console":                  "ഡിപിഒ കൺസോൾ",
        "dpo_console_caption":          "എല്ലാ ഡാറ്റ വിഷയ അവകാശ അഭ്യർത്ഥനകളും അവലോകനം ചെയ്യുക.",
        "officer_console":              "ഓഫീസർ കൺസോൾ",
        "officer_console_caption":      "നിങ്ങളുടെ ശാഖയ്ക്കുള്ള അവകാശ അഭ്യർത്ഥനകൾ അവലോകനം ചെയ്യുക.",
        "no_rights_requests":           "അവകാശ അഭ്യർത്ഥനകൾ കണ്ടെത്തിയില്ല.",
        "rights_filter_type":           "തരം അനുസരിച്ച് ഫിൽട്ടർ ചെയ്യുക",
        "rights_filter_status":         "സ്റ്റാറ്റസ് അനുസരിച്ച് ഫിൽട്ടർ ചെയ്യുക",
        "rights_all_types":             "എല്ലാ തരങ്ങളും",
        "rights_all_statuses":          "എല്ലാ സ്റ്റാറ്റസുകളും",
        "consent_access_restricted":    "ആക്സസ് നിയന്ത്രിതം. ഡാറ്റ സംരക്ഷണ ഉദ്യോഗസ്ഥനെ ബന്ധപ്പെടുക.",
        "consent_contact_dpo":          "ഉയർന്ന ആക്സസ്സ് ആവശ്യപ്പെടാൻ ഡാറ്റ സംരക്ഷണ ഉദ്യോഗസ്ഥനെ ബന്ധപ്പെടുക.",
        "notices_init_error":           "നോട്ടീസ് ആരംഭ പിശക്.",
        "breach_load_error":            "ലംഘന സംഭവങ്ങൾ ലോഡ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു.",
        "breach_init_error":            "ലംഘന മൊഡ്യൂൾ ആരംഭ പിശക്.",
        "escalation_summary":           "എസ്കലേഷൻ സംഗ്രഹം",
        "no_escalations":               "സജീവ എസ്കലേഷനുകൾ ഇല്ല.",
        "weighted_compliance_score":    "ഭാരിത അനുസരണ സ്കോർ",
        "score_label":                  "Score",
        "weight_label":                 "Weight",
        "evidence_label":               "തെളിവ്",
        "compliant":                    "അനുസൃതം",
        "non_compliant":                "അനനുസൃതം",
        "partial":                      "ഭാഗികം",
        "request_id_label":             "അഭ്യർത്ഥന ഐഡി",
        "request_type_label":           "അഭ്യർത്ഥനയുടെ തരം",
        "request_status_label":         "Status",
        "request_submitted_at":         "സമർപ്പിച്ച സമയം",
        "request_deadline":             "അവസാന തീയതി",
        "request_sla_status":           "എസ്എൽഎ സ്റ്റാറ്റസ്",
        "identity_verified_label":      "ഐഡന്റിറ്റി സ്ഥിരീകരിച്ചു",
        "verify_identity_btn":          "ഐഡന്റിറ്റി സ്ഥിരീകരിക്കുക",
        "approve_request_btn":          "അംഗീകരിക്കുക",
        "reject_request_btn":           "Reject",
        "escalate_request_btn":         "എസ്കലേറ്റ് ചെയ്യുക",
        "dpia_new":                     "പുതിയ ഡിപിഐഎ",
        "dpia_list":                    "ഡിപിഐഎ രജിസ്റ്റർ",
        "dpia_no_records":              "ഡിപിഐഎ രേഖകൾ കണ്ടെത്തിയില്ല.",
        "dpia_pending":                 "തീർപ്പുകൽപ്പിക്കാത്തത്",
        "dpia_approved":                "അംഗീകരിച്ചത്",
        "dpia_rejected":                "നിരസിച്ചത്",
        "dpia_high":                    "High",
        "dpia_medium":                  "Medium",
        "dpia_low":                     "Low",

        # ── Remaining missing keys (Malayalam mirrors English) ────────────
        "amendment_ref":                "ഭേദഗതി റഫറൻസ്",
        "assisted_mode_label":          "സഹായിക്കപ്പെട്ട സമർപ്പണ മോഡ്",
        "clause_scores":                "ക്ലോസ് സ്കോറുകൾ",
        "clause_status":                "ക്ലോസ് സ്റ്റാറ്റസ്",
        "compliance_trend":             "അനുസരണ ട്രെൻഡ്",
        "consent_load_error":           "സമ്മത രേഖകൾ ലോഡ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു.",
        "dpia_approve_btn":             "അംഗീകരിക്കുക",
        "dpia_approved_at":             "അംഗീകരിച്ച സമയം",
        "dpia_approved_by":             "അംഗീകരിച്ചത്",
        "dpia_approved_msg":            "ഡിപിഐഎ അംഗീകരിച്ചു.",
        "dpia_created":                 "ഡിപിഐഎ വിജയകരമായി സമർപ്പിച്ചു.",
        "dpia_data_categories":         "ഡാറ്റ വിഭാഗങ്ങൾ",
        "dpia_decision":                "തീരുമാനം",
        "dpia_description":             "വിവരണം",
        "dpia_detail":                  "ഡിപിഐഎ വിശദാംശങ്ങൾ",
        "dpia_draft":                   "Draft",
        "dpia_due_soon":                "ഉടൻ അവസാനിക്കുന്നത്",
        "dpia_filter_risk":             "അപകടസാധ്യത അനുസരിച്ച് ഫിൽട്ടർ ചെയ്യുക",
        "dpia_filter_status":           "സ്റ്റാറ്റസ് അനുസരിച്ച് ഫിൽട്ടർ ചെയ്യുക",
        "dpia_id_label":                "DPIA ID",
        "dpia_next_review":             "അടുത്ത അവലോകന തീയതി",
        "dpia_notes":                   "ഡിപിഒ കുറിപ്പുകൾ",
        "dpia_periodic_review":         "ആനുകാലിക അവലോകന ഷെഡ്യൂൾ",
        "dpia_processing_purpose":      "പ്രോസസ്സിംഗ് ഉദ്ദേശ്യം",
        "dpia_project":                 "പ്രോജക്ട് / സിസ്റ്റം",
        "dpia_reject_btn":              "Reject",
        "dpia_rejected_msg":            "ഡിപിഐഎ നിരസിച്ചു.",
        "dpia_residual_risk":           "അവശിഷ്ട അപകടസാധ്യത",
        "dpia_retention_period":        "സൂക്ഷിക്കൽ കാലയളവ്",
        "dpia_review_due":              "അവലോകനം ബാക്കി",
        "dpia_risk_evaluation":         "അപകടസാധ്യതാ മൂല്യനിർണ്ണയം",
        "dpia_risk_level":              "അപകടസാധ്യതാ നില",
        "dpia_safeguards":              "സംരക്ഷണ നടപടികൾ",
        "dpia_save":                    "Save",
        "dpia_section_header":          "ഡിപിഐഎ & സ്വകാര്യതാ മൂല്യനിർണ്ണയങ്ങൾ",
        "dpia_status":                  "Status",
        "dpia_submit_btn":              "ഡിപിഐഎ സമർപ്പിക്കുക",
        "dpia_submitted_at":            "സമർപ്പിച്ച സമയം",
        "dpia_submitted_by":            "സമർപ്പിച്ചത്",
        "dpia_third_parties":           "ഉൾപ്പെട്ട മൂന്നാം കക്ഷികൾ",
        "escalated_to":                 "എസ്കലേറ്റ് ചെയ്തത്",
        "escalation_level":             "എസ്കലേഷൻ നില",
        "framework_scores":             "ചട്ടക്കൂട് സ്കോറുകൾ",
        "get_escalation_summary":       "എസ്കലേഷൻ സംഗ്രഹം",
        "notice_publish_error":         "നോട്ടീസ് പ്രസിദ്ധീകരിക്കുന്നതിൽ പരാജയപ്പെട്ടു.",
        "notice_save_error":            "നോട്ടീസ് സംരക്ഷിക്കുന്നതിൽ പരാജയപ്പെട്ടു.",
        "notices_load_error":           "സ്വകാര്യതാ നോട്ടീസുകൾ ലോഡ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു.",
        "pending_remediation":          "പരിഹാരം കാത്തിരിക്കുന്നു",
        "remediation_actions":          "പരിഹാര നടപടികൾ",
        "request_customer":             "ഉപഭോക്തൃ ഐഡി",
        "request_decision":             "തീരുമാനം",
        "request_notes":                "Notes",
        "rights_closed":                "Closed",
        "rights_escalated":             "എസ്കലേറ്റ് ചെയ്തത്",
        "rights_in_progress":           "പ്രോസസ്സ് ചെയ്യുന്നു",
        "rights_open":                  "Open",
        "risk_heatmap":                 "അപകടസാധ്യതാ ഹീറ്റ്മാപ്",
        "score_breakdown":              "സ്കോർ വിഭജനം",
        "sla_breach_count":             "എസ്എൽഎ ലംഘന എണ്ണം",
        "submit_on_behalf":             "ഉപഭോക്താവിന് വേണ്ടി സമർപ്പിക്കുക",
        # ── Auto-generated parity keys ───────────────────────────────────
        "access":                                      "Access",
        "active_cases":                                "സജീവ കേസുകൾ",
        "active_request_progress":                     "സജീവ അഭ്യർത്ഥനയുടെ പുരോഗതി",
        "active_sessions":                             "സജീവ സെഷനുകൾ",
        "all_incidents_closed":                        "എല്ലാ സംഭവങ്ങളും അടച്ചു",
        "all_requests_by_status":                      "സ്റ്റാറ്റസ് അനുസരിച്ച് എല്ലാ അഭ്യർത്ഥനകളും",
        "all_requests_closed":                         "എല്ലാ അഭ്യർത്ഥനകളും (അടച്ചത്)",
        "all_requests_live_sla":                       "എല്ലാ അഭ്യർത്ഥനകളും — ലൈവ് എസ്എൽഎ",
        "all_requests_live_sla_readonly":              "എല്ലാ അഭ്യർത്ഥനകളും — ലൈവ് എസ്എൽഎ (വായന മാത്രം)",
        "all_requests_sla":                            "എല്ലാ അഭ്യർത്ഥനകളും എസ്എൽഎ",
        "all_submitted":                               "എല്ലാം സമർപ്പിച്ചു",
        "approaching_deadline":                        "അവസാന തീയതി അടുക്കുന്നു",
        "assisted":                                    "സഹായിക്കപ്പെട്ടത്",
        "assisted_branch_officer":                     "ശാഖ ഓഫീസർ സഹായിച്ചത്",
        "assisted_consent_info":                       "ഓഫീസർ ഉപഭോക്താവിന് വേണ്ടി സമ്മതം രേഖപ്പെടുത്തി.",
        "assisted_consent_registered_reason":          "ഓഫീസർ സഹായിച്ച സമ്മതം രജിസ്റ്റർ ചെയ്തു.",
        "assisted_consent_registered_title":           "സഹായിക്കപ്പെട്ട സമ്മതം രജിസ്റ്റർ ചെയ്തു",
        "assisted_submission":                         "സഹായിക്കപ്പെട്ട സമർപ്പണം",
        "audit_events_today":                          "ഇന്നത്തെ ഓഡിറ്റ് ഇവന്റുകൾ",
        "auditor_no_revoke_renew":                     "ഓഡിറ്റർമാർക്ക് സമ്മതം റദ്ദാക്കാനോ പുതുക്കാനോ കഴിയില്ല.",
        "auditor_readonly_info":                       "ഓഡിറ്റർ കാഴ്ച വായന മാത്രം.",
        "auditor_rights_caption":                      "എല്ലാ അവകാശ അഭ്യർത്ഥനകളുടെയും വായനാ-മാത്ര കാഴ്ച.",
        "auto_escalated_when_red":                     "എസ്എൽഎ ചുവപ്പ് ആകുമ്പോൾ സ്വയം എസ്കലേറ്റ് ആകും.",
        "awaiting_action":                             "നടപടി കാത്തിരിക്കുന്നു",
        "being_processed":                             "പ്രോസസ്സ് ചെയ്യുന്നു",
        "branch_notes":                                "ശാഖ കുറിപ്പുകൾ",
        "branch_requests":                             "ശാഖ അഭ്യർത്ഥനകൾ",
        "branch_risk_overview":                        "ശാഖ അപകടസാധ്യതാ അവലോകനം",
        "capture_assisted_consent":                    "സഹായിക്കപ്പെട്ട സമ്മതം രേഖപ്പെടുത്തുക",
        "close_dpia":                                  "ഡിപിഐഎ അടയ്ക്കുക",
        "closed_at":                                   "അടച്ച സമയം",
        "compliance_customer_hint":                    "ഈ റോളിന് അനുസരണ കാഴ്ച വായന മാത്രം.",
        "compliance_regression_reason":                "അനുസരണ സ്കോറിൽ തിരിച്ചടി കണ്ടെത്തി.",
        "compliance_regression_title":                 "അനുസരണ തിരിച്ചടി",
        "compliance_score_trend":                      "അനുസരണ സ്കോർ ട്രെൻഡ്",
        "compliant_clauses":                           "അനുസൃത ക്ലോസുകൾ",
        "compliant_threshold":                         "അനുസൃത പരിധി",
        "confirm_authority_notification":              "അധികൃത അറിയിപ്പ് സ്ഥിരീകരിക്കുക",
        "confirm_authority_notification_help":         "നിയന്ത്രണ അധികൃതനെ അറിയിച്ചതായി സ്ഥിരീകരിക്കുക.",
        "consent_creation_info":                       "പുതിയ സമ്മതത്തിന് ഉപഭോക്തൃ ഐഡന്റിറ്റി സ്ഥിരീകരണം ആവശ്യമാണ്.",
        "consent_gate":                                "സമ്മത ഗേറ്റ്",
        "consent_lifecycle_caption":                   "ഉപയോക്തൃ സമ്മതത്തിന്റെ ജീവിതചക്രം",
        "consent_lifecycle_info":                      "എല്ലാ സമ്മത നടപടികളും ഓഡിറ്റ് ലെഡ്ജറിൽ രേഖപ്പെടുത്തും.",
        "consent_registered_reason":                   "പുതിയ സമ്മതം രജിസ്റ്റർ ചെയ്തു.",
        "consent_registered_title":                    "സമ്മതം രജിസ്റ്റർ ചെയ്തു",
        "consent_renewed_reason":                      "സമ്മതം വിജയകരമായി പുതുക്കി.",
        "consent_renewed_title":                       "സമ്മതം പുതുക്കി",
        "consent_revoked_reason":                      "സമ്മതം റദ്ദ് ചെയ്തു.",
        "consent_revoked_title":                       "സമ്മതം റദ്ദ് ചെയ്തു",
        "consent_status_legend":                       "സജീവം | റദ്ദ് ചെയ്തത് | കാലഹരണപ്പെട്ടത് | പുതുക്കിയത്",
        "consent_withdrawn":                           "സമ്മതം പിൻവലിച്ചു",
        "consents_by_purpose":                         "ഉദ്ദേശ്യം അനുസരിച്ച് സമ്മതങ്ങൾ",
        "consents_by_status":                          "സ്റ്റാറ്റസ് അനുസരിച്ച് സമ്മതങ്ങൾ",
        "content_ml":                                  "മലയാളം ഉള്ളടക്കം",
        "correction":                                  "തിരുത്തൽ",
        "count":                                       "എണ്ണം",
        "created":                                     "സൃഷ്ടിച്ചത്",
        "critical_dpia_escalation_reason":             "ഗുരുതര അപകടസാധ്യതയുള്ള ഡിപിഐഎ ഡിപിഒ അംഗീകാരം ആവശ്യമാണ്.",
        "critical_dpia_escalation_title":              "ഗുരുതര ഡിപിഐഎ എസ്കലേറ്റ് ചെയ്തു",
        "customer":                                    "ഉപഭോക്താവ്",
        "customer_decision":                           "ഉപഭോക്തൃ തീരുമാനം",
        "customer_id_required":                        "ഉപഭോക്തൃ ഐഡി ആവശ്യമാണ്.",
        "customer_portal_caption":                     "ഡിപിഡിപി നിയമം 2023 പ്രകാരം നിങ്ങളുടെ ഡാറ്റ അവകാശ അഭ്യർത്ഥനകൾ സമർപ്പിക്കുക.",
        "customer_revoke_info":                        "ഉപഭോക്താക്കൾക്ക് ഏത് സമയത്തും സമ്മതം റദ്ദ് ചെയ്യാം.",
        "customer_rights_caption":                     "ഡിജിറ്റൽ വ്യക്തിഗത ഡാറ്റ സംരക്ഷണ നിയമം 2023 പ്രകാരമുള്ള നിങ്ങളുടെ അവകാശങ്ങൾ.",
        "customer_rights_sla_note":                    "ഡിപിഡിപി നിയമം സെക്ഷൻ 13 പ്രകാരം 30 ദിവസത്തിനുള്ളിൽ അഭ്യർത്ഥനകൾ പ്രോസസ് ചെയ്യും.",
        "data_categories_involved":                    "ഉൾപ്പെട്ട ഡാറ്റ വിഭാഗങ്ങൾ",
        "date":                                        "Date",
        "days_left":                                   "ബാക്കി ദിവസങ്ങൾ",
        "decision_metadata":                           "തീരുമാന മെറ്റാഡാറ്റ",
        "deny_consent":                                "സമ്മതം നിഷേധിക്കുക",
        "describe_mitigation_action":                  "കൈക്കൊണ്ട ലഘൂകരണ നടപടി വിവരിക്കുക.",
        "describe_processing_activity":                "പ്രോസസ്സിംഗ് പ്രവർത്തനം വിവരിക്കുക.",
        "download_trend_csv":                          "ട്രെൻഡ് CSV ഡൗൺലോഡ് ചെയ്യുക",
        "dpdp_timely_processing_note":                 "ഡിപിഡിപി നിയമം 2023 എല്ലാ അവകാശ അഭ്യർത്ഥനകളുടെയും സമയബദ്ധമായ പ്രോസസ്സിംഗ് നിർദ്ദേശിക്കുന്നു.",
        "dpia_analytics":                              "ഡിപിഐഎ വിശകലനം",
        "dpia_closed_success":                         "ഡിപിഐഎ വിജയകരമായി അടച്ചു.",
        "dpia_creation_note":                          "ഉയർന്ന അപകടസാധ്യതയുള്ള ഏതൊരു പ്രോസസ്സിംഗ് പ്രവർത്തനത്തിനും ഡിപിഐഎ ആരംഭിക്കുക.",
        "dpia_creation_restricted":                    "ഡിപിഐഎ സൃഷ്ടി ഓഫീസർമാർക്കും ഡിപിഒക്കും മാത്രം.",
        "dpia_id":                                     "DPIA ID",
        "dpia_initiated_reason":                       "പുതിയ ഡിപിഐഎ ആരംഭിച്ചു.",
        "dpia_initiated_title":                        "ഡിപിഐഎ ആരംഭിച്ചു",
        "dpia_register":                               "ഡിപിഐഎ രജിസ്റ്റർ",
        "dpia_title":                                  "ഡിപിഐഎ തലക്കെട്ട്",
        "dpia_title_placeholder":                      "ഉദാ. ഉപഭോക്തൃ ഡാറ്റ അനലിറ്റിക്സ് പ്ലാറ്റ്ഫോം",
        "dpia_workflow_advanced_reason":               "ഡിപിഐഎ വർക്ക്ഫ്ലോ ഘട്ടം മുന്നോട്ട് നീക്കി.",
        "dpia_workflow_advanced_title":                "വർക്ക്ഫ്ലോ ഘട്ടം മുന്നോട്ട് നീക്കി",
        "dpias_by_risk_level":                         "അപകടസാധ്യതാ നില അനുസരിച്ച് ഡിപിഐഎകൾ",
        "dpias_by_workflow_stage":                     "വർക്ക്ഫ്ലോ ഘട്ടം അനുസരിച്ച് ഡിപിഐഎകൾ",
        "dpo_auditor_no_consent_creation":             "ഡിപിഒക്കും ഓഡിറ്റർമാർക്കും നേരിട്ട് സമ്മതം സൃഷ്ടിക്കാനാകില്ല.",
        "dpo_review_required":                         "ഡിപിഒ അവലോകനം ആവശ്യമാണ്.",
        "dpo_submission_info":                         "ഡിപിഒക്ക് ഉപഭോക്താക്കൾക്ക് വേണ്ടി അഭ്യർത്ഥനകൾ സമർപ്പിക്കാം.",
        "drift_detected":                              "വ്യതിയാനം കണ്ടെത്തി",
        "erasure":                                     "മായ്ക്കൽ",
        "escalate":                                    "എസ്കലേറ്റ് ചെയ്യുക",
        "escalated_overdue_requests":                  "എസ്കലേറ്റ് / കാലഹരണപ്പെട്ട അഭ്യർത്ഥനകൾ",
        "escalated_to_dpo":                            "ഡിപിഒക്ക് എസ്കലേറ്റ് ചെയ്തു",
        "escalations":                                 "എസ്കലേഷനുകൾ",
        "estimated_records_affected":                  "ബാധിച്ചതായി കണക്കാക്കിയ രേഖകൾ",
        "event":                                       "Event",
        "event_type":                                  "ഇവന്റ് തരം",
        "expires":                                     "കാലഹരണപ്പെടുന്നു",
        "failed_logins":                               "പരാജയപ്പെട്ട ലോഗിനുകൾ",
        "filter_by_branch":                            "ശാഖ അനുസരിച്ച് ഫിൽട്ടർ ചെയ്യുക",
        "filter_by_purpose":                           "ഉദ്ദേശ്യം അനുസരിച്ച് ഫിൽട്ടർ ചെയ്യുക",
        "final_override_dpo_warning":                  "അന്തിമ ഓവർറൈഡിന് ഡിപിഒ അധികാരം ആവശ്യമാണ്.",
        "flagged_for_dpo_review":                      "ഡിപിഒ അവലോകനത്തിനായി ഫ്ലാഗ് ചെയ്തു",
        "for_dpo_action":                              "ഡിപിഒ നടപടിക്കായി",
        "full_ids_visible":                            "പൂർണ്ണ ഐഡി ദൃശ്യമാണ് (ഡിപിഒ/ഓഡിറ്റർ കാഴ്ച).",
        "grant_consent":                               "സമ്മതം നൽകുക",
        "grievance":                                   "പരാതി",
        "hash_freeze_note":                            "പ്രസിദ്ധീകരിച്ച നോട്ടീസുകൾ ഹാഷ്-ഫ്രോസ്ൺ ആണ്, എഡിറ്റ് ചെയ്യാനാകില്ല.",
        "high_critical_risk":                          "ഉയർന്ന / ഗുരുതര അപകടസാധ്യത",
        "his_branch":                                  "ഈ ശാഖ",
        "id":                                          "ID",
        "id_verified":                                 "ഐഡി സ്ഥിരീകരിച്ചു",
        "identity_marked_verified":                    "ഐഡന്റിറ്റി സ്ഥിരീകരിച്ചതായി അടയാളപ്പെടുത്തി.",
        "identity_verification_required_error":        "പ്രോസസ്സ് ചെയ്യുന്നതിന് മുൻപ് ഐഡന്റിറ്റി സ്ഥിരീകരണം ആവശ്യമാണ്.",
        "identity_verified":                           "ഐഡന്റിറ്റി സ്ഥിരീകരിച്ചു",
        "identity_verified_confirm":                   "ഐഡന്റിറ്റി നേരിട്ടോ ഒടിപി വഴിയോ സ്ഥിരീകരിച്ചതായി ഉറപ്പിക്കുക.",
        "ids_masked_policy":                           "ഡാറ്റ ലഘൂകരണ നയം അനുസരിച്ച് ഉപഭോക്തൃ ഐഡി മറയ്ക്കപ്പെടുന്നു.",
        "immediate_attention":                         "ഉടനടി ശ്രദ്ധ ആവശ്യമാണ്",
        "initiate_new_dpia":                           "പുതിയ ഡിപിഐഎ ആരംഭിക്കുക",
        "initiator":                                   "ആരംഭിച്ചയാൾ",
        "kpi_realtime_note":                           "കെപിഐകൾ ലൈവ് സമ്മത രജിസ്ട്രിയിൽ നിന്ന് ഉത്ഭവിക്കുന്നു.",
        "mark_identity_verified":                      "ഐഡന്റിറ്റി സ്ഥിരീകരിച്ചതായി അടയാളപ്പെടുത്തുക",
        "mitigation_action_label":                     "ലഘൂകരണ നടപടി",
        "mitigation_action_placeholder":               "പ്രയോഗിച്ച നിയന്ത്രണം അല്ലെങ്കിൽ ലഘൂകരണം വിവരിക്കുക.",
        "mitigation_restricted":                       "ലഘൂകരണ രേഖപ്പെടുത്തൽ ഡിപിഒക്ക് മാത്രം.",
        "mitigation_workflow":                         "ലഘൂകരണ വർക്ക്ഫ്ലോ",
        "my_request_history":                          "എന്റെ അഭ്യർത്ഥനാ ചരിത്രം",
        "my_requests_only_caption":                    "നിങ്ങൾ സമർപ്പിച്ച അഭ്യർത്ഥനകൾ മാത്രം കാണിക്കുന്നു.",
        "my_total_requests":                           "എന്റെ ആകെ അഭ്യർത്ഥനകൾ",
        "na":                                          "N/A",
        "new_dpia":                                    "പുതിയ ഡിപിഐഎ",
        "next_review":                                 "അടുത്ത അവലോകനം",
        "next_review_date":                            "അടുത്ത അവലോകന തീയതി",
        "no_approval_history":                         "അംഗീകാര ചരിത്രം ഇല്ല.",
        "no_consent_data":                             "സമ്മത രേഖകൾ കണ്ടെത്തിയില്ല.",
        "no_data_yet":                                 "ഡാറ്റ ഇതുവരെ ഇല്ല.",
        "no_dpia_data_to_analyse":                     "വിശകലനം ചെയ്യാൻ ഡിപിഐഎ ഡാറ്റ ഇല്ല.",
        "no_dpias_available":                          "ഡിപിഐഎകൾ ലഭ്യമല്ല.",
        "no_dpias_awaiting_approval":                  "അംഗീകാരം കാത്തിരിക്കുന്ന ഡിപിഐഎകൾ ഇല്ല.",
        "no_dpias_recorded":                           "ഡിപിഐഎകൾ രേഖപ്പെടുത്തിയിട്ടില്ല.",
        "no_dpias_to_export":                          "എക്സ്പോർട്ട് ചെയ്യാൻ ഡിപിഐഎകൾ ഇല്ല.",
        "no_dpo_approved_dpias_to_close":              "അടയ്ക്കാൻ ഡിപിഒ അംഗീകരിച്ച ഡിപിഐഎകൾ ഇല്ല.",
        "no_escalated_requests":                       "എസ്കലേറ്റ് ചെയ്ത അഭ്യർത്ഥനകൾ ഇല്ല.",
        "no_evidence_recorded":                        "തെളിവ് രേഖപ്പെടുത്തിയിട്ടില്ല.",
        "no_notices_recorded":                         "സ്വകാര്യതാ നോട്ടീസുകൾ രേഖപ്പെടുത്തിയിട്ടില്ല.",
        "no_open_dpias_mitigation":                    "ലഘൂകരണത്തിന് തുറന്ന ഡിപിഐഎകൾ ഇല്ല.",
        "no_records_match_filters":                    "തിരഞ്ഞെടുത്ത ഫിൽട്ടറുകൾ ഒന്നും പൊരുത്തപ്പെടുന്നില്ല.",
        "no_requests_submitted_yet":                   "ഇതുവരെ അഭ്യർത്ഥനകൾ സമർപ്പിച്ചിട്ടില്ല.",
        "no_transitions_available":                    "മാറ്റങ്ങൾ ലഭ്യമല്ല.",
        "no_trend_data":                               "ട്രെൻഡ് ഡാറ്റ ലഭ്യമല്ല.",
        "non_compliant_clauses":                       "അനനുസൃത ക്ലോസുകൾ",
        "notes_context":                               "കുറിപ്പുകൾ / സന്ദർഭം",
        "notification_required_before_closure":        "അടയ്ക്കുന്നതിന് മുൻപ് അധികൃത അറിയിപ്പ് ആവശ്യമാണ്.",
        "officer_assisted_caption":                    "ഉപഭോക്താവിന് വേണ്ടി അവകാശ അഭ്യർത്ഥന സമർപ്പിക്കുക.",
        "officer_assisted_info":                       "ഓഫീസർ സഹായിച്ച സമർപ്പണം ഓഡിറ്റ് ലെഡ്ജറിൽ രേഖപ്പെടുത്തും.",
        "officer_assisted_more_info":                  "സഹായിക്കപ്പെട്ട സമർപ്പണങ്ങൾക്ക് ഉപഭോക്തൃ ഐഡന്റിറ്റി സ്ഥിരീകരണം ആവശ്യമാണ്.",
        "officer_branch_requests_caption":             "നിങ്ങളുടെ ശാഖയിൽ സമർപ്പിച്ച അവകാശ അഭ്യർത്ഥനകൾ.",
        "officer_compliance_limited_view":             "ഓഫീസർമാർക്ക് പരിമിതമായ അനുസരണ കാഴ്ച മാത്രം.",
        "officer_consent_warning":                     "സമ്മത നടപടികൾ ബന്ധിതവും ഓഡിറ്റ്-ലോഗ് ചെയ്തതുമാണ്.",
        "officer_id_verification_confirm":             "ഉപഭോക്താവിന്റെ ഐഡന്റിറ്റി സ്ഥിരീകരിച്ചതായി ഉറപ്പിക്കുക.",
        "open_in_progress":                            "തുറന്നത് / പ്രോസസ്സ് ചെയ്യുന്നത്",
        "open_requests_by_sla":                        "എസ്എൽഎ സ്റ്റാറ്റസ് അനുസരിച്ച് തുറന്ന അഭ്യർത്ഥനകൾ",
        "overall_score_pct":                           "മൊത്തം സ്കോർ (%)",
        "partial_threshold":                           "ഭാഗിക പരിധി",
        "past_review_date":                            "അവലോകന തീയതി കഴിഞ്ഞു",
        "preview_request":                             "അഭ്യർത്ഥന പ്രിവ്യൂ",
        "preview_request_customer_view":               "പ്രിവ്യൂ (ഉപഭോക്തൃ കാഴ്ച)",
        "previous_version_id":                         "മുൻ പതിപ്പ് ഐഡി",
        "processing_activity_description":             "പ്രോസസ്സിംഗ് പ്രവർത്തന വിവരണം",
        "processing_activity_placeholder":             "വ്യക്തിഗത ഡാറ്റ പ്രോസസ് ചെയ്യുന്ന വിധം വിവരിക്കുക.",
        "processing_purpose":                          "പ്രോസസ്സിംഗ് ഉദ്ദേശ്യം",
        "provide_dpia_title":                          "ദയവായി ഒരു ഡിപിഐഎ തലക്കെട്ട് നൽകുക.",
        "provide_rejection_reason":                    "ദയവായി നിരസിക്കലിന്റെ കാരണം നൽകുക.",
        "published_by":                                "പ്രസിദ്ധീകരിച്ചത്",
        "purpose_dpia_linkage_help":                   "ഈ ഡിപിഐഎ ഒരു രജിസ്റ്റർ ചെയ്ത സമ്മത ഉദ്ദേശ്യവുമായി ലിങ്ക് ചെയ്യുക.",
        "rate_limit_exceeded_session":                 "ഈ സെഷനിൽ അധിക സമർപ്പണങ്ങൾ. പിന്നീട് ശ്രമിക്കുക.",
        "re_authorised":                               "വീണ്ടും അംഗീകരിച്ചു",
        "reason":                                      "കാരണം",
        "records":                                     "രേഖകൾ",
        "red_escalated":                               "ചുവപ്പ് / എസ്കലേറ്റ് ചെയ്തത്",
        "regulatory_clause_reference_title":           "നിയന്ത്രണ ക്ലോസ് റഫറൻസ്",
        "regulatory_export_dpia_reports":              "ഡിപിഐഎ റിപ്പോർട്ടുകൾ എക്സ്പോർട്ട് ചെയ്യുക",
        "regulatory_export_note":                      "നിയന്ത്രണ സമർപ്പണത്തിനോ ഓഡിറ്റിനോ എക്സ്പോർട്ട് ചെയ്യുക.",
        "regulatory_reports":                          "നിയന്ത്രണ റിപ്പോർട്ടുകൾ",
        "rejection_reason":                            "നിരസിക്കലിന്റെ കാരണം",
        "reported_incidents":                          "റിപ്പോർട്ട് ചെയ്ത സംഭവങ്ങൾ",
        "requires_reconsent":                          "വീണ്ടും സമ്മതം ആവശ്യമാണ്",
        "requires_renewal":                            "പുതുക്കൽ ആവശ്യമാണ്",
        "resolution_note":                             "പരിഹാര കുറിപ്പ്",
        "reviews_overdue":                             "അവലോകനം കാലഹരണപ്പെട്ടു",
        "revocation_reason":                           "റദ്ദ് ചെയ്യലിന്റെ കാരണം",
        "revocation_reason_placeholder":               "റദ്ദ് ചെയ്യലിന്റെ കാരണം നൽകുക...",
        "revoked_at":                                  "റദ്ദ് ചെയ്ത സമയം",
        "revoked_by_officer_default":                  "ഓഫീസർ റദ്ദ് ചെയ്തു",
        "rights_invocation_reason":                    "ഈ അവകാശം ഉപയോഗിക്കുന്നതിന്റെ കാരണം",
        "rights_invocation_title":                     "അവകാശ ഉപയോഗം",
        "rights_requests":                             "അവകാശ അഭ്യർത്ഥനകൾ",
        "risk_level_auto_computed_note":               "അപകടസാധ്യതാ നില മൂല്യനിർണ്ണയത്തിൽ നിന്ന് സ്വയം കണക്കാക്കും.",
        "risk_score_distribution":                     "അപകടസാധ്യതാ സ്കോർ വിതരണം",
        "risk_score_distribution_all_dpias":           "അപകടസാധ്യതാ സ്കോർ വിതരണം — എല്ലാ ഡിപിഐഎകളും",
        "search_customer_id":                          "ഉപഭോക്തൃ ഐഡി ഉപയോഗിച്ച് തിരയുക",
        "select_dpia":                                 "ഡിപിഐഎ തിരഞ്ഞെടുക്കുക",
        "select_dpia_to_close":                        "അടയ്ക്കാൻ ഡിപിഐഎ തിരഞ്ഞെടുക്കുക",
        "select_dpia_to_preview":                      "പ്രിവ്യൂ ചെയ്യാൻ ഡിപിഐഎ തിരഞ്ഞെടുക്കുക",
        "select_request":                              "അഭ്യർത്ഥന തിരഞ്ഞെടുക്കുക",
        "self_service":                                "സ്വയം സേവനം",
        "sla_amber":                                   "എസ്എൽഎ ആംബർ",
        "sla_analytics":                               "എസ്എൽഎ വിശകലനം",
        "sla_green":                                   "എസ്എൽഎ ഗ്രീൻ",
        "sla_legend_note":                             "ഗ്രീൻ: ട്രാക്കിൽ | ആംബർ: അവസാന തീയതി അടുക്കുന്നു | ചുവപ്പ്: കാലഹരണപ്പെട്ടു",
        "sla_performance_analytics":                   "എസ്എൽഎ പ്രകടന വിശകലനം",
        "sla_red":                                     "എസ്എൽഎ ചുവപ്പ്",
        "snapshot_at":                                 "സ്നാപ്ഷോട്ട് സമയം",
        "snapshot_date":                               "സ്നാപ്ഷോട്ട് തീയതി",
        "snapshot_history":                            "സ്നാപ്ഷോട്ട് ചരിത്രം",
        "stage":                                       "Stage",
        "stage_advancement_restricted":                "ഘട്ട മുന്നേറ്റം നിയന്ത്രിതമാണ്.",
        "submit_assisted_request":                     "സഹായിക്കപ്പെട്ട അഭ്യർത്ഥന സമർപ്പിക്കുക",
        "submit_my_consent":                           "എന്റെ സമ്മതം സമർപ്പിക്കുക",
        "submit_on_behalf_of_customer":                "ഉപഭോക്താവിന് വേണ്ടി സമർപ്പിക്കുക",
        "submitted":                                   "സമർപ്പിച്ചു",
        "submitted_on":                                "സമർപ്പിച്ച തീയതി",
        "supporting_details":                          "പ്രസക്ത വിശദാംശങ്ങൾ",
        "system_uptime":                               "സിസ്റ്റം അപ്ടൈം",
        "target_stage":                                "ലക്ഷ്യ ഘട്ടം",
        "third_parties_involved_label":                "ഉൾപ്പെട്ട മൂന്നാം കക്ഷികൾ",
        "total_dpias":                                 "ആകെ ഡിപിഐഎകൾ",
        "trend_caption":                               "കാലക്രമേണ അനുസരണ സ്കോർ ട്രെൻഡ്.",
        "trend_more_info":                             "സ്കോർ ലൈവ് സിസ്റ്റം അവസ്ഥയിൽ നിന്ന് ഉത്ഭവിക്കുന്നു — സമ്മതം, എസ്എൽഎ, ലംഘനം, ഡിപിഐഎ, ഓഡിറ്റ്.",
        "triggered_by":                                "ആരംഭിച്ചത്",
        "unknown":                                     "അജ്ഞാതം",
        "user":                                        "User",
        "verification_method":                         "സ്ഥിരീകരണ രീതി",
        "view_history_for":                            "ചരിത്രം കാണുക",
        "weight":                                      "Weight",
        "within_window":                               "വിൻഡോക്കുള്ളിൽ",
        "your_consents":                               "നിങ്ങളുടെ സമ്മതങ്ങൾ",
        "your_customer_id":                            "നിങ്ങളുടെ ഉപഭോക്തൃ ഐഡി",
        "your_decision":                               "നിങ്ങളുടെ തീരുമാനം",

        # ── Round-3 parity keys ──────────────────────────────────────────
        "access_my_data":                              "എന്റെ ഡാറ്റ ആക്സസ് ചെയ്യുക",
        "audit_access_restricted":                     "ആക്സസ് നിയന്ത്രിതം. ഓഡിറ്റ് ലോഗുകൾ ഈ റോളിന് വായന മാത്രം.",
        "audit_contact_dpo":                           "പൂർണ്ണ ഓഡിറ്റ് ആക്സസ്സിന് ഡാറ്റ സംരക്ഷണ ഉദ്യോഗസ്ഥനെ ബന്ധപ്പെടുക.",
        "auditor":                                     "ഓഡിറ്റർ",
        "authenticated":                               "പ്രാമാണീകരിക്കപ്പെട്ടു",
        "board_member":                                "ബോർഡ് അംഗം",
        "branch_officer":                              "ശാഖ ഓഫീസർ",
        "consent_withdrawal_action":                   "സമ്മത പിൻവലിക്കൽ",
        "correct_my_data":                             "എന്റെ ഡാറ്റ തിരുത്തുക",
        "create_rights_request":                       "അവകാശ അഭ്യർത്ഥന സൃഷ്ടിക്കുക",
        "data_access":                                 "ഡാറ്റ ആക്സസ്",
        "data_access_request":                         "ഡാറ്റ ആക്സസ് അഭ്യർത്ഥന",
        "data_correction":                             "ഡാറ്റ തിരുത്തൽ",
        "data_correction_request":                     "ഡാറ്റ തിരുത്തൽ അഭ്യർത്ഥന",
        "data_erasure":                                "ഡാറ്റ മായ്ക്കൽ",
        "data_erasure_request":                        "ഡാറ്റ മായ്ക്കൽ അഭ്യർത്ഥന",
        "dpo":                                         "DPO",
        "erase_my_data":                               "എന്റെ ഡാറ്റ മായ്ക്കുക",
        "grievance_redressal":                         "പരാതി പരിഹാരം",
        "kyc":                                         "KYC",
        "kyc_verification":                            "കെവൈസി സ്ഥിരീകരണം",
        "last_active":                                 "അവസാനം സജീവം",
        "loan_processing":                             "വായ്പ പ്രോസസ്സിംഗ്",
        "login_account_locked":                        "പല പരാജയകരമായ ശ്രമങ്ങൾ കാരണം അക്കൗണ്ട് ലോക്ക് ചെയ്തു. {minutes} മിനിറ്റിനു ശേഷം ശ്രമിക്കുക.",
        "login_error":                                 "ലോഗിൻ പിശക്. സിസ്റ്റം അഡ്മിനിസ്ട്രേറ്ററെ ബന്ധപ്പെടുക.",
        "login_lockout_wait":                          "അക്കൗണ്ട് ലോക്ക് ചെയ്തിരിക്കുന്നു. {minutes} മിനിറ്റ് കാത്തിരിക്കുക.",
        "login_time":                                  "ലോഗിൻ സമയം",
        "mfa_enter_code":                              "നിങ്ങളുടെ 6-അക്ക ഓതന്റിക്കേറ്റർ കോഡ് നൽകുക",
        "mfa_invalid":                                 "അസാധുവായ അല്ലെങ്കിൽ കാലഹരണപ്പെട്ട കോഡ്. വീണ്ടും ശ്രമിക്കുക.",
        "mfa_required":                                "മൾട്ടി-ഫാക്ടർ പ്രാമാണീകരണം ആവശ്യമാണ്",
        "mfa_secret":                                  "എംഎഫ്എ രഹസ്യം",
        "mfa_verified":                                "എംഎഫ്എ സ്ഥിരീകരിച്ചു",
        "mfa_verify":                                  "Verify",
        "nominate_representative":                     "പ്രതിനിധിയെ നിർദ്ദേശിക്കുക",
        "nomination_request":                          "നിർദ്ദേശ അഭ്യർത്ഥന",
        "password_hash":                               "പാസ്‌വേഡ് ഹാഷ്",
        "privacy_steward":                             "സ്വകാര്യതാ സ്റ്റുവാർഡ്",
        "regional_officer":                            "റീജിയണൽ ഓഫീസർ",
        "request":                                     "അഭ്യർത്ഥന",
        "requires_id_verification":                    "ഐഡന്റിറ്റി സ്ഥിരീകരണം ആവശ്യമാണ്",
        "requires_mandatory_id_verification":          "നിർബന്ധിത ഐഡന്റിറ്റി സ്ഥിരീകരണം ആവശ്യമാണ്",
        "revoke_consent_request":                      "സമ്മതം റദ്ദ് ചെയ്യൽ",
        "role":                                        "Role",
        "stage_closed":                                "Closed",
        "stage_dpo_approved":                          "ഡിപിഒ അംഗീകരിച്ചു",
        "stage_initiated":                             "ആരംഭിച്ചു",
        "stage_rejected":                              "നിരസിച്ചു",
        "stage_steward_approved":                      "സ്റ്റുവാർഡ് അംഗീകരിച്ചു",
        "stage_under_review":                          "അവലോകനത്തിൽ",
        "steward_approved":                            "സ്റ്റുവാർഡ് അംഗീകരിച്ചു",
        "system_admin":                                "സിസ്റ്റം അഡ്മിൻ",
        "under_review":                                "അവലോകനത്തിൽ",
        "unknown_user":                                "അജ്ഞാത ഉപഭോക്താവ്",
        "valid_consent_required_for":                  "ഇതിന് സാധുതയുള്ള സമ്മതം ആവശ്യമാണ്",
        "warning":                                     "മുന്നറിയിപ്പ്",

        # ── Rights portal — missing keys (rights_portal.py) ──────────────────
        "assigned_on_submit":                   "സമർപ്പിക്കുമ്പോൾ നിയോഗിക്കും",
        "closed_on_time":                       "സമയത്തിന് അടച്ചു",
        "closed_resolved_within_window":        "അടച്ചു — എസ്എൽഎ കാലാവധിക്കുള്ളിൽ പരിഹരിച്ചു",
        "closure_blocked":                      "അടയ്ക്കൽ തടഞ്ഞു",
        "days_remaining_until":                 "ദിവസം ശേഷിക്കുന്നത് വരെ",
        "enter_above":                          "മുകളിൽ നൽകുക",
        "escalated_priority_attention":         "എസ്കലേറ്റ് ചെയ്തു — മുൻഗണനാ ശ്രദ്ധ ആവശ്യമാണ്.",
        "identity_verification_failed":         "ഐഡന്റിറ്റി സ്ഥിരീകരണം പരാജയപ്പെട്ടു",
        "identity_verification_required":       "ഐഡന്റിറ്റി സ്ഥിരീകരണം ആവശ്യമാണ്",
        "identity_verification_warning":        "ഈ അഭ്യർത്ഥന തരത്തിന് സമർപ്പിക്കുന്നതിന് മുൻപ് ഐഡന്റിറ്റി സ്ഥിരീകരണം ആവശ്യമാണ്.",
        "identity_verified_at":                 "ഐഡന്റിറ്റി സ്ഥിരീകരിച്ച സമയം",
        "identity_verified_by":                 "ഐഡന്റിറ്റി സ്ഥിരീകരിച്ചത്",
        "left":                                 "ശേഷിക്കുന്നു",
        "must_confirm_id_verification_before":  "ഒരു അഭ്യർത്ഥന സമർപ്പിക്കുന്നതിന് മുൻപ് ഐഡന്റിറ്റി സ്ഥിരീകരണം ഉറപ്പാക്കണം:",
        "of":                                   "ൽ",
        "on_date":                              "തീയതിയിൽ",
        "policy_violation":                     "നയ ലംഘനം",
        "request_blocked":                      "അഭ്യർത്ഥന തടഞ്ഞു",
        "request_blocked_consent_gate":         "അഭ്യർത്ഥന തടഞ്ഞു — സമ്മതം ആവശ്യം",
        "request_overdue_by":                   "അഭ്യർത്ഥന കാലതാമസം",
        "request_submitted_success":            "അഭ്യർത്ഥന വിജയകരമായി സമർപ്പിച്ചു. ഐഡി:",
        "requests":                             "അഭ്യർത്ഥനകൾ",
        "requests_escalated_at":                "അഭ്യർത്ഥന(കൾ) എസ്കലേറ്റ് ചെയ്തു",
        "requests_require_dpo_attention":       "അഭ്യർത്ഥന(കൾ) ഡിപിഒ ശ്രദ്ധ ആവശ്യം.",
        "requires_dpo_attention":               "ഡിപിഒ ശ്രദ്ധ ആവശ്യമാണ്.",
